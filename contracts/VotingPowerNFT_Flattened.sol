...
// Flattened VotingPowerNFT contract with inline OpenZeppelin dependencies
// This file combines all necessary contracts for manual verification
...
// ERC721.sol (simplified for this use case)
...
contract VotingPowerNFT is ERC721, Ownable {
    ...
    constructor(string memory name_, string memory symbol_)
        ...
        Ownable()
    {
        // Owner is automatically set to contract deployer
    }
